...
public class Runigram {
	...
	public static void main(String[] args) {
		...
		// Tests the blanded for color function:
		System.out.println();
		Color c1  = new Color(100, 40, 100);
		Color c2  = new Color(200, 20, 40);
		System.out.println(blend(c1, c2, 0.25));

		// Tests the blanded for images function:
		System.out.println();
		imageOut = blend(tinypic, cake, 0.25);
		print(imageOut);
	...
	public static Color luminance(Color pixel) {
		...
		Color lum = new Color(lumC, lumC, lumC);
		return lum;
	}
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		...
		for(int i = 0; i < height; i++) {
			for(int j = 0; j < width; j++) {
				Newimage[i][j] = image[(int)(i*(h0/h))][(int)(j*(w0/w))];
			}
		}
		return Newimage;
	}
